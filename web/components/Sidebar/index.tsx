  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image width={176} height={32} src={"/logo1.png"} alt="Logo" />
        </Link>
        ...
        <nav className="px-4 py-4 mt-5 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Forms --> */}
              {address === "0x6fD41d4aAD84e9432cD9c0a344Ba6245989e4E41" && (
                <SidebarLinkGroup
                  activeCondition={
